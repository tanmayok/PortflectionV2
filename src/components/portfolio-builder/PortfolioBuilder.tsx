...
const mockSectionConfigs: SectionConfig[] = [
  {
    ...
    type: 'hero',
    name: 'Hero Section',
    description: 'Main introduction section with name, title, and call-to-action',
    icon: 'user',
    category: 'header',
    fields: [
      {
...
export const PortfolioBuilder = () => {
  ...
  const [selectedTheme, setSelectedTheme] = useState<ThemeConfig>(mockThemes[0]);
  ...
  const handleCustomizationStateChange = useCallback((updates: Partial<CustomizationState>) => {
  ...
  const handleUndo = useCallback(() => {
    ...
    setSelectedTheme(themeHistory.past[themeHistory.past.length - 1] || selectedTheme);
              ...
              <TabsContent value="theme" className="mt-4">
                <ThemeSelector
                  ...
                  onPreviewTheme={(theme) => {
                    handleThemeSelect(theme);
                    setCustomizationState(prev => ({ ...prev, mode: 'preview' }));
                  }}
                />
              </TabsContent>
